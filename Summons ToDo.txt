...
Keybind to summon first of the list that you can spam. SUMMONING BOT

4 - Overkill : 

- Once you are summoning, polls every 4 seconds if the cast is still on going and ask for people to come to your coordinates :
"I need clickers to summon people @ x,y" then "come click" then repeat

- Print the list of summoned persons to the raid ?
